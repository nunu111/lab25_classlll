...
ComplexNumber ComplexNumber::operator*(const ComplexNumber &c){
	double freal,fimag;
	freal = (real*c.real)-(imag*c.imag);
	fimag = (real*c.imag)+(imag*c.real);
	return ComplexNumber(freal,fimag);
}

ComplexNumber ComplexNumber::operator/(const ComplexNumber &c){
	double freal,fimag;
	freal = ((real*c.real)+ (imag*c.imag))/((c.real*c.real)+(c.imag*c.imag));
	fimag = ((imag*c.real)- (real*c.imag))/((c.real*c.real)+(c.imag*c.imag));
	return ComplexNumber(freal,fimag);
}
...
ComplexNumber operator*(double s,const ComplexNumber &c){
	double freal,fimag;
	freal = (s*c.real)-(0*c.imag);
	fimag = (s*c.imag)+(0*c.real);
	return ComplexNumber(freal,fimag);
}

ComplexNumber operator/(double s,const ComplexNumber &c){
	double freal,fimag;
	freal = ((s*c.real)+ (0*c.imag))/((c.real*c.real)+(c.imag*c.imag));
	fimag = ((0*c.real)- (s*c.imag))/((c.real*c.real)+(c.imag*c.imag));
	return ComplexNumber(freal,fimag);
}
